...
--Find the number of CLERKS employed. 
...
--analysts earning more than 1200 who are based in department
select * from Employees
...
-- Find out the names of the employees whose name begin with 'A'and ends with 'M'
...
--all managers who have more than 2 employees reporting 
